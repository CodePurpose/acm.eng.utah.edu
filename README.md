# University of Utah ACM([Live Demo](http://chibicode.github.io/solo/))

[University of Utah ACM](http://acm.eng.utah.edu) is a Jekyll theme that supports **single-page websites** only, but supports them well. Yes, it's responsive.
